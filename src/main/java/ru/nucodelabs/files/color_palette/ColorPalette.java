...
public class ColorPalette implements ColorMapper {
    ...
    public ColorPalette(List<ValueColor> valueColorList, DoubleProperty minValue, DoubleProperty maxValue, int blocksCnt) {
        this.valueColorList = valueColorList;
        this.minValue = minValue;
        this.maxValue = maxValue;
        this.blocksCnt = blocksCnt;
        if (blocksCnt < 2) throw new RuntimeException("Число блоков меньше 2");
        blocksInit();
    }
    ...
    private void blocksInit() {
        ...
        double blockSize = 1.0 / blocksCnt;
    ...
    private record ColorBlock(double from, double to, Color color) {
