...
//
//        int dimension = modelData.size() * 2 - 1; // -1 - мощность последнего слоя не передается как параметр
...
//
//            List<Double> solvedResistance = SonetForwardSolver.solve(currentModelResistance, currentModelPower, experimentalAB_2);
//
